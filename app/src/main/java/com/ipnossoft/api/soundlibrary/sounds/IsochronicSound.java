...
public class IsochronicSound extends Sound {
  private String frequency;
  private int frequencyId;

  public IsochronicSound() {
  }

  public IsochronicSound(String var1, int var2, int var3, int var4, int var5, int var6, int var7, String var8, int var9, boolean var10, String var11, String var12) {
  ...
  public static <T extends Sound> List<T> loadSoundsFromResourceArray(Context var0, @ArrayRes int var1) {
    ...
    while(var1 < var2.length()) {
      ...
      IsochronicSound var18 = new IsochronicSound(var4, var7, var8, var9, var10, var11, var12, var5, var14, var6, var0.getResources().getString(var15), var0.getResources().getString(var17));
